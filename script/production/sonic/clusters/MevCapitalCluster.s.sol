...
contract Cluster is ManageCluster {
    ...
    function configureCluster() internal override {
        ...
        cluster.supplyCaps[scETH    ] = 10_000;
        cluster.supplyCaps[scUSD    ] = 100_000_000;
        cluster.supplyCaps[wstkscETH] = 25_000;
        cluster.supplyCaps[wstkscUSD] = 10_000_000;
        cluster.supplyCaps[wS       ] = 100_000_000;
        cluster.supplyCaps[stS      ] = 100_000_000;
        cluster.supplyCaps[wOS      ] = 0;

        // define borrow caps here. 0 means no borrow can occur, type(uint256).max means no cap defined hence max amount
        cluster.borrowCaps[WETH     ] = 4_000;
        cluster.borrowCaps[USDC     ] = 9_000_000;
        cluster.borrowCaps[scETH    ] = 4_800;
        cluster.borrowCaps[scUSD    ] = 10_000_000;
        cluster.borrowCaps[wstkscETH] = 15_000;
        cluster.borrowCaps[wstkscUSD] = 5_000_000;
        cluster.borrowCaps[wS       ] = 100_000_000;
        cluster.borrowCaps[stS      ] = 10_000_000;
        cluster.borrowCaps[wOS      ] = 0;

        // define IRMs
        cluster.irms[WETH     ] = 0x5754eC4efAc25662009e5268f9814b43cE1A8263;
        cluster.irms[USDC     ] = 0x5754eC4efAc25662009e5268f9814b43cE1A8263;
        cluster.irms[scETH    ] = 0x3009dB521e9B781637DA5C53323322dAa0B0bDE1;
        cluster.irms[scUSD    ] = 0x3009dB521e9B781637DA5C53323322dAa0B0bDE1;
        cluster.irms[wstkscETH] = 0x3009dB521e9B781637DA5C53323322dAa0B0bDE1;
        cluster.irms[wstkscUSD] = 0x3009dB521e9B781637DA5C53323322dAa0B0bDE1;
        cluster.irms[wS       ] = 0x7C3cCD7dFEE5054834f70B16A90d5157a199b197;
        cluster.irms[stS      ] = 0x7C3cCD7dFEE5054834f70B16A90d5157a199b197;
        cluster.irms[wOS      ] = 0x7C3cCD7dFEE5054834f70B16A90d5157a199b197;
